...
static void
crypto_stream_blabla20_rounds(uint64_t st[16])
{
    int i;
...
static void
crypto_stream_blabla20_update(uint64_t ks[16], uint64_t st[16])
{
    int i;
